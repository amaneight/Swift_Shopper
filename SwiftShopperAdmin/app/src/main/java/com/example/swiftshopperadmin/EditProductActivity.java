...
public class EditProductActivity extends Activity {
    ...
    // single product url
    private static final String url_product_detials = "http://www.amaneight.byethost3.com/get_product_details.php";
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (success == 1) {
                            ...
                            // Edit Text
                            txtBarcode = (EditText) findViewById(R.id.inputBarcode);
                            txtName = (EditText) findViewById(R.id.inputName);
                            txtBrand = (EditText) findViewById(R.id.inputBrand);
                            txtPrice = (EditText) findViewById(R.id.inputPrice);
                            txtQty = (EditText) findViewById(R.id.inputQuantity);
                            txtWt = (EditText) findViewById(R.id.inputWeight);
